...
final class Deposit extends JPanel {
	...
	public Deposit() {
		...
		depositLabel = new JLabel("Uplata");
		...
		depositAmountLabel = new JLabel("Cifra za uplatu:");
		...
		depositAmountField.setToolTipText("Unesite cifru koju zelite da uplatite na racun.");
		...
		depositButton = new JButton("Uplata novca");
		depositButton.setToolTipText("Uplatite zelejni iznos na racun.");
